...
<html lang="en">
	...
	<body class="<?php echo $page->uid() ?><?php if ($page->isParent()): ?> <?php echo $page->parent()->uid() ?><?php endif ?><?php if ($page->parent()->uid() == 'portfolio'): ?> case-study<?php endif ?><?php if ($page->parent()->uid() == 'journal'): ?> journal-entry<?php endif ?>">
